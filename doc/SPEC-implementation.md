# Business Factory V1 Implementation Spec
...
Business Factory V1 must provide a full control-plane loop for autonomous agents:
...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.business-factory/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.business-factory/instances/default/data/storage` (`local_disk`)
...
- exactly one JSON entrypoint: `business-factory.manifest.json`
