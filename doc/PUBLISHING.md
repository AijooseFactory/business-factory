...
Low-level reference for how Business Factory packages are built for npm.
...
The CLI package, `business-factoryai`, imports code from workspace packages such as:

- `@business-factoryai/server`
- `@business-factoryai/db`
- `@business-factoryai/shared`
...
- `npx business-factoryai@canary onboard` can install them explicitly
- `npx business-factoryai onboard` continues to resolve `latest`
