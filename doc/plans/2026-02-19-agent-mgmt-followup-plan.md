...
- `skills/business-factory/SKILL.md` and `skills/business-factory/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/business-factory/SKILL.md`
...
## 6.2 `skills/business-factory-create-agent/SKILL.md`
