...
- installed adapter list for this Business Factory instance
...
## 8. New Skill: `business-factory-create-agent`

Create new skill directory:

- `skills/business-factory-create-agent/SKILL.md`
- `skills/business-factory-create-agent/references/api-reference.md`
...
Also update `skills/business-factory/SKILL.md` to reference this skill for hiring workflows.
...
- `business-factory-create-agent` skill + docs updates
