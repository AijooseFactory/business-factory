...
describe("mergeJoinDefaultsPayloadForReplay", () => {
  it("merges replay payloads and allows gateway token override", () => {
    ...
    // During rebranding transition, businessFactoryApiUrl stays as-is from existing defaults
    // and paperclipApiUrl is added as a separate field. This will be consolidated post-rebrand.
    expect(normalized.businessFactoryApiUrl).toBe("http://host.docker.internal:3100");
