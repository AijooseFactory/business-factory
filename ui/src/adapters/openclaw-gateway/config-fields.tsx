...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      <Field label="Gateway payload contract">
        <div className="text-xs text-muted-foreground leading-relaxed">
          OpenClaw Gateway accepts a strict top-level agent request schema. Supported payload-template keys include
          `agentId`, delivery/session fields, `extraSystemPrompt`, `label`, `spawnedBy`, and `workspaceDir`.
          Unsupported keys such as top-level `metadata` are ignored at runtime.
        </div>
      </Field>
