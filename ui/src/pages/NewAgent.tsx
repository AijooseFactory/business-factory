...
import { AGENT_ROLES } from "@business-factory/shared";
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="border border-border">
              ...
              >
                {currentReportsTo ? (
                  ...
                  <>
                    ...
                    {isFirstAgent ? "Reports to: N/A (Human CEO)" : "Reports to..."}
                  </>
                )}
              </button>
            </PopoverTrigger>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">This will be your Chief of Staff</p>
          )}
          {formError && (
