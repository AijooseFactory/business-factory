...
export interface ServerAdapterModule {
  ...
  /**
   * When false, Paperclip preserves configured project workspaces even if the Paperclip server
   * cannot stat the path locally (for example remote/cloud adapters executing elsewhere).
   */
  usesServerLocalWorkspace?: boolean;
  models?: AdapterModel[];
