...
# Open-source orchestration for zero-human or human-in-the-loop companies

**Business Factory is an Ai Business orchestration platform.**

The Business Factory is a clone of the Paperclip project, but with many improvements and new features. It is a Node.js server and React UI that orchestrates a team of Ai agents to run a business. It has org charts, budgets, governance, goal alignment, and agent coordination.
...
<table>
  <tr>
    ...
    <td align="center"><img src="doc/assets/logos/agent-zero.svg" width="32" alt="Agent Zero" /><br/><sub>Agent Zero</sub></td>
